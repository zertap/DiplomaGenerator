...
{\rule{2.5cm}{1em}\hspace{-2.5cm} osaamista sekä \rule{1.5cm}{1em}\hspace{-1.5cm}taitoa digitaalisen tekemisen saralla.} \\

\vfill

\footnotesize
\textcolor{instanssired}{Linkki Jyväskylä ry:n ja Instanssin virallisesti valtuuttamina} \\
